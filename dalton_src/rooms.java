public class rooms {
	...
	public rooms(int maxKingbedsAvailable, int maxQueenbedsAvailable, int maxSuitebedsAvailable, int kingbedsOccupied,
			int queenbedsOccupied, int suitebedsOccupied) {
