...
public class AvailableRooms {
    ...
    /**
     * Constructs a new AvailableRooms object with default values.
    ...
    /**
     * Constructs a new AvailableRooms object with specified maximum bed and occupancy values.
    ...
    public AvailableRooms(int maxKingBedsAvailable, int maxQueenBedsAvailable, int maxSuiteBedsAvailable, int kingBedsOccupied, int queenBedsOccupied, int suiteBedsOccupied) {
