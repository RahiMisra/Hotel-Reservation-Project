...
public class GUI implements ActionListener {
	...
	GUI() {
		...
		kingBedButton.setBounds(1000, 210, 150, 50);
		kingBedButton.setText("Master Suite");
		frame.add(kingBedButton);

		queenBedButton.setBounds(1000, 450, 150, 50);
		queenBedButton.setText("Family Suite");
		frame.add(queenBedButton);

		suiteBedButton.setBounds(1000, 750, 150, 50);
		suiteBedButton.setText("Queen Suite");
